...
// // Prevent scroll-view from jumping on Android
...
// //       businessEmail: formData.businessEmail.trim(),
// //       businessPhone: `+92${formData.businessPhone.replace(/\s/g, '')}`,
// //       city: null, // Add city picker if needed
// //       area: null, // Add area picker if needed
// //       location: null, // Add map location if needed
// //       isFemaleOnly: false, // Add toggle if needed
...
// //         index: 0,
// //         routes: [{
// //           name: 'VendorDashboard', // or 'VendorDashboard' if you have one
// //           params: {
// //             vendorProfile: result.data.data.profile,
// //           }
// //         }],
// //       });
// //     } else {
